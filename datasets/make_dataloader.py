...
def make_dataloader(cfg):
    ...
    if cfg.MODEL.UDA_STAGE == 'UDA':
        ...
        train_set2 = ImageDataset(dataset.valid, val_transforms)
        img_num2 = len(dataset.train)
    ...
    if cfg.MODEL.TASK_TYPE == 'classify_DA':
        if cfg.MODEL.UDA_STAGE == 'UDA':
            return train_loader, train_loader_normal, val_loader, None, num_classes, cam_num, view_num, train_loader1, train_loader2, img_num1, img_num2, dataset
        else:
